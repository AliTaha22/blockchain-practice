...
const connectContract = async () => {
    ...
    const contractAddress = "0xE3A57B38D80101Cf20820E3cA96C70677465FBa1";
    ...
    console.log("Owner of TokenID " + tokenID + " :", tokenOwner);

    const contractSigner = contract.connect(signer);
    let tx = await contractSigner.transferFrom(owner, "0xa1eB35A03D01611f661220349037F5E4C1D0F53F", 1);

    console.log(tx);
    tokenOwner = await contract.ownerOf(tokenID);
    console.log("Owner of TokenID " + tokenID + "After Transfer :", tokenOwner);
